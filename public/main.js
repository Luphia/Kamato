...
$(function() {
  ...
  function addChatMessage (data, options) {
    ...
    var $usernameDiv = $('<span class="username"/>')
      .css('background', getUsernameColor(data.user.name));
    var $nameDiv = $('<a/>').text(data.user.name)
      .appendTo($usernameDiv);
    var $messageBodyDiv = $('<span class="messageBody">')
      .text(data.message);
    var $timestampDiv = $('<span class="timestamp">')
      .text(formatDate(new Date(data.timestamp)));
    ...
    if(data.user && data.user.image) {
      $usernameDiv.css('background', 'url(' + data.user.image + ')');
    }
